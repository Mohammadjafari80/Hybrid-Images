...
points_near = []
img_near = cv2.imread('./input/near.jpg')
...
points_far = []
img_far = cv2.imread('./input/far.jpg')
...
cv2.imwrite('near-transformed.jpg', transformed_near)
cv2.imwrite('far-transformed.jpg', img_far)
...
cv2.imwrite('dft-near.jpg', normalize(dft_near))
...
cv2.imwrite('dft-far.jpg', normalize(dft_far))


r = 35
s = 15
hp_mask, lp_mask = get_mask_filters(b_near.shape, s, r)
cv2.imwrite(f'highpass.jpg', hp_mask * 255)
cv2.imwrite(f'lowpass.jpg', lp_mask * 255)
...
cv2.imwrite('highpassed.jpg', normalize(image_high_pass))
...
cv2.imwrite('lowpassed.jpg', normalize(image_low_pass))
...
cv2.imwrite('hybrid-dft.jpg', normalize(img_avg))
